											...
											<tr>
												...
												<td>
													...
													<?php if($access[$aco_id]["_delete"] == 1):?>
														<a href="javascript:void(0);" onclick="Delete('Are you sure want to delete this data?','<?php echo $data[$ModelName]['id']?>')" class="btn btn-danger btn-condensed text-center" title="Access Control">
