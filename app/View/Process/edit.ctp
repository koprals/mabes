...
<ul class="breadcrumb">
	...
	<li class="javascript:void(0)"><?php echo "Edit Keberangkatan Pendidikan"?></li>
</ul>
<!-- END BREADCRUMB -->
<!-- PAGE TITLE -->
<div class="page-title">
	<h2><span class="fa fa-plus-circle"></span> Edit Keberangkatan</h2>
</div>
<!-- END PAGE TITLE -->
				...
				<?php echo $this->Form->create($ModelName, array('url' => array("controller"=>$ControllerName,"action"=>"Edit"),'class' => 'form-horizontal',"type"=>"file")); ?>
					<div class="panel panel-default">
						<div class="panel-heading">
								<h3 class="panel-title"><strong>Edit</strong> Keberangkatan</h3>
						</div>
