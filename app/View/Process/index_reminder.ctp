...
$(document).ready(function(){
	...
	$("#contents_area").load("<?php echo $settings['cms_url'] . $ControllerName?>/ListItemReminder/page:<?php echo $page?>/limit:<?php echo $viewpage?>/?time=<?php echo time()?>",function(){
		$("#contents_area").css("opacity","1");
...
function SearchAdvance()
{
	$("#SearchAdvance").ajaxSubmit({
		url:"<?php echo $settings['cms_url'].$ControllerName ?>/ListItemReminder",
		type:'POST',
		dataType: "html",
		clearForm:false,
		beforeSend:function()
...
<div class="page-title">
	<h2><span class="fa fa-list-ul"></span> List Siswa Sedang Pendidikan</h2>
</div>
<!-- END PAGE TITLE -->
