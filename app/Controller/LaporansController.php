...
class LaporansController extends AppController
{
	...
	function ListItem()
	{
		...
		{
			$this->params['named']['page']	=	$this->params['paging']['Process']['pageCount'];
		}
	...
	function Add($personnel_id = null)
	{
		...
		$personnels	=	$this->Process->find('first',array(
			'conditions'	=>	array(
				'Process.personnel_id' => $personnel_id
			),
			'recursive'	=> 1
		));
		//debug($personnels);
