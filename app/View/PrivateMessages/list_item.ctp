											...
											<tr>
												...
												<td>
													...
													<?php if($access[$aco_id]["_delete"] == 1):?>
															<a href="javascript:void(0);" onclick="Delete('Are you sure want to delete this data?','<?php echo $data[$ModelName]['id_pesan']?>')" class="btn btn-danger btn-condensed" title="Access Control">
